...
description: >
  ...
  of findings. Saves to autodiscovery-results/experiment-cards/.
...
with open("autodiscovery-results/validation/<runid>_triage.json") as f:
    triage = json.load(f)
...
```bash
mkdir -p autodiscovery-results/experiment-cards/literature_evidence
```

Write two files:

**`autodiscovery-results/experiment-cards/literature_evidence/<experiment_id>_literature.json`**
...
**`autodiscovery-results/experiment-cards/<experiment_id>_card.md`**
...
with open("autodiscovery-results/experiment-cards/literature_evidence/<experiment_id>_literature.json") as f:
